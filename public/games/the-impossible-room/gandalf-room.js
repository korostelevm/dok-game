class GandalfRoom extends RoomBase {
	...
	addMonkor() {
		...
		this.joker.changePosition(this.joker.x, this.joker.y - 90, this.joker.z, engine.lastTime);
	}
	...
	updateGandalf(time) {
		...
		if (this.gandalf.falling) {
			this.gandalf.dy ++;
			this.gandalf.changePosition(this.gandalf.x + 1, this.gandalf.y + this.gandalf.dy, this.gandalf.z, time);
		}
	}
