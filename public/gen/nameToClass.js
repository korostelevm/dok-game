...
document.addEventListener('DOMContentLoaded', () => {
  NAME_TO_CLASS["ActionManager"] = ActionManager;		// lib/core/actions/action-manager.js
  NAME_TO_CLASS["AnimationActionManager"] = AnimationActionManager;		// lib/core/actions/animation-action-manager.js
  NAME_TO_CLASS["Active"] = Active;		// lib/core/base/active.js
  ...
  NAME_TO_CLASS["State"] = State;		// lib/core/state.js
  ...
  NAME_TO_CLASS["RefresherAuxiliary"] = RefresherAuxiliary;		// lib/sprite/aux/base/refresher-auxiliary.js
  NAME_TO_CLASS["SpriteActionManager"] = SpriteActionManager;		// lib/sprite/aux/base/sprite-action-manager.js
  NAME_TO_CLASS["ToggleClickAuxiliary"] = ToggleClickAuxiliary;		// lib/sprite/aux/base/toggle-click-auxiliary.js
  NAME_TO_CLASS["Refresher"] = Refresher;		// lib/utils/refresher/base/refresher.js
  ...
  NAME_TO_CLASS["HighlightAuxiliary"] = HighlightAuxiliary;		// lib/sprite/aux/highlight-auxiliary.js
  ...
  NAME_TO_CLASS["MuteAuxiliary"] = MuteAuxiliary;		// lib/sprite/aux/mute-auxiliary.js
  NAME_TO_CLASS["NpcAuxiliary"] = NpcAuxiliary;		// lib/sprite/aux/npc-auxiliary.js
  NAME_TO_CLASS["OnFrameEndAuxiliary"] = OnFrameEndAuxiliary;		// lib/sprite/aux/on-frame-end-auxiliary.js
  ...
  NAME_TO_CLASS["StateAuxiliary"] = StateAuxiliary;		// lib/sprite/aux/state-auxiliary.js
  ...
  NAME_TO_CLASS["SpriteMapper"] = SpriteMapper;		// lib/map/sprite-mapper.js
  ...
  NAME_TO_CLASS["TextureEdgeCalculator"] = TextureEdgeCalculator;		// lib/texture/texture-edge-calculator.js
  NAME_TO_CLASS["TextureManager"] = TextureManager;		// lib/texture/texture-manager.js
  NAME_TO_CLASS["CursorManager"] = CursorManager;		// lib/ui/cursor-manager.js
  ...
  NAME_TO_CLASS["GameStateSelector"] = GameStateSelector;		// lib/ui/game-state-selector.js
