...
Constants.RENDER_FLAG = {
	SPRITE_ATTRIBUTE: Constants.UPDATE_FLAG.ACTIVE|Constants.UPDATE_FLAG.OPACITY
		|Constants.UPDATE_FLAG.SPRITE|Constants.UPDATE_FLAG.ANIMATION,
	TEXTURE: Constants.UPDATE_FLAG.ANIMATION|Constants.UPDATE_FLAG.OPACITY
		|Constants.UPDATE_FLAG.LIGHT
