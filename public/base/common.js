...
const SOUNDS = {
	...
	HAHAHA:'sounds/hahaha.wav',
	BIRTHDAY:'sounds/birthday.wav',
	HEY:'sounds/hey.wav',
	GUN_SHOT:'sounds/gun-shot.wav',
	DUD:'sounds/dud.wav',
	ALIEN:'sounds/alien.wav',
	HIT:'sounds/hit.wav',
	PLAYER_HURT:'sounds/player-hurt.wav',
	HIT_LAND:'sounds/hit-land.wav',
	PICKUP:'sounds/pickup.wav',
	EAT: 'sounds/eat.wav',
	DRINK: 'sounds/drink.wav',
	JAIL_CELL_THEME: 'sounds/jail-cell-theme.wav',
	CHIN_TOK_THEME: 'sounds/chintok.wav',
	ERROR: 'sounds/error.wav',
	FUTURE_SONG_THEME: 'sounds/future-song.wav',
	JINGLE: 'sounds/jingle.wav',
	DARK_THEME: 'sounds/dark.wav',
	BATTLE_THEME: 'sounds/battle-theme.wav',
	FOE_DEFEAT: 'sounds/foe-defeat.wav',
	LAZER: 'sounds/lazer.wav',
	DOOR: 'sounds/door.wav',
	UNLOCK: 'sounds/unlock.wav',
	BEEP: 'sounds/beep.wav',
	BOP: 'sounds/bop.wav',
	YUPA: 'sounds/yupa.wav',
	YUPA_HAHA: 'sounds/yupa-haha.wav',
	FEMBOT: 'sounds/fembot.wav',
	DIVING: 'sounds/diving.wav',
	HUM: 'sounds/hum.wav',
	GOGOL: 'sounds/gogol.wav',
	SOUP_CHOU_THEME: 'sounds/soup-chou.wav',
	OKAY: 'sounds/okay.wav',
	YAP: 'sounds/yap.wav',
	HUHUH: 'sounds/huhuh.wav',
	SOFT_THEME: 'sounds/soft-song.wav',
	ANIMAL_CRY: 'sounds/animal-cry.wav',
	MUSETTE: 'sounds/musette.wav',
	WAITER: 'sounds/waiter.wav',
	YULA: 'sounds/yula.wav',
	BABY_CRY: "sounds/baby-cry.wav",
	GOLDMAN_THEME: "sounds/goldman.wav",
	F1: "sounds/f1.wav",
	RANDOM: "sounds/random.wav",
	MYSTICA_THEME: "sounds/mystica.wav",
	SELECT: "sounds/select.wav",
	WEAKPUNCH: "sounds/weakpunch.wav",
	ROBOT_VOICE: "sounds/robot-voice.wav",
	HUM_LADY: "sounds/hum-lady.wav",
	HUM_KID: "sounds/hum-kid.wav",
	TURTLE_SONG_THEME: "sounds/turtle-song.wav",
	HELLO_HUMAN: "sounds/hello-human.wav",
	INVALID_NUMBER: "sounds/invalid-number.wav",
	GRUMP: "sounds/grump.wav",
	YES_BOSS: "sounds/yes-boss-low.wav",
	YES_SIR: "sounds/yes-boss.wav",
	GOOD_BAD_UGLIZ: "sounds/good-bad-ugliz.wav",
	WELCOME_TO_YOUR_DOOM: "sounds/welcome-to-your-doom.wav",
	BEEBOP_THEME:'sounds/beebop.wav',
};
